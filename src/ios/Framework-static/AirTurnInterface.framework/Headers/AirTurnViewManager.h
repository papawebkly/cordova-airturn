...
/*!
 *  @property enabled
 *  @brief A Boolean value that determines whether the AirTurn view manager is enabled
 ...
 *  @discussion If set YES, resigns the AirTurn View as first responder until set back to NO.
...
/*!
 *  @property parentView
 *  @brief The parent view of the AirTurn view
 *  @discussion You can manually set the parent window for the Airturn view.  If you do not do this, it is added to the view of the root view controller of the key window when enabled.
 */
 ...
 *  After removing itself from the passed view the AirTurn view will automatically attach to the first subview of the key window.
 *
 ...
 *
 *  @return YES if the AirTurn view became the first responder
 */
 ...
 *
 *  @return YES if the AirTurn view is currently the first responder
 */
